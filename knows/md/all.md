...
45. vue的编译和webpack的编译


46. 静态资源和动态资源
静态资源： 就是客户端请求web服务器获取资源，web从内存中获取资源，返回给客户端，客户端进行解析
动态资源： 客户端发送请求获取动态资源，先将请求交给web容器，web容器链接数据库，数据库将数据处理后返回给web容器，web服务器将内容返回给客户端进行解析渲染。
